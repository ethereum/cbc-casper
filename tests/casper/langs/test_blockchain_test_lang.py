...
def test_check_estimate_passes_on_valid_assertions(blockchain_lang):
...
def test_checks_fails_on_invalid_assertions(test_string, blockchain_lang):
    with pytest.raises(AssertionError):
        blockchain_lang.parse(test_string)


def test_check_safe_passes_on_valid_assertions(blockchain_lang):
...
def test_check_unsafe_passes_on_valid_assertions(blockchain_lang):
